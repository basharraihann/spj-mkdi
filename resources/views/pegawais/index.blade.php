    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-2xl border border-gray-100 p-6 space-y-6">
                ...
                {{-- Search & filter bar --}}
                <form action="{{ route('pegawais.index') }}" method="GET" class="flex flex-wrap items-end gap-3">
                    ...
                    @if (request()->filled('q') || request()->filled('jabatan') || request()->filled('status'))
                ...
                @else
                    ...
                    @foreach ($unitGroups as $unitIndex => $group)
                        <div class="border border-gray-100 rounded-2xl overflow-hidden" x-data="{ openUnit: true }">
                            <button type="button" @click="openUnit = !openUnit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    :class="{ 'rotate-180': openUnit }" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.sortable-body').forEach(function (tbody) {
                Sortable.create(tbody, {
                    ...
                    onEnd: function () {
                        // Update nomor urut yang tampil tanpa reload halaman
