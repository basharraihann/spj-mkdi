                        ...
                        <tr data-id="{{ $pegawai->id }}" class="js-pegawai-row group hover:bg-gray-50/60 transition"
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="inline-flex items-center gap-1.5">
                                    ...
                                    <x-delete-button :action="route('pegawais.destroy', $pegawai)" :label="'pegawai ' . $pegawai->nama" :id="'pegawai-' . $pegawai->id"
                                        class="flex-1 w-full justify-center px-3 py-2 rounded-md text-xs font-semibold border border-red-200 text-red-500 bg-white active:bg-red-50 transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="flex items-center gap-2 mt-3.5 pt-3 border-t border-gray-50">
                            ...
                            <x-delete-button :action="route('pegawais.destroy', $pegawai)" :label="'pegawai ' . $pegawai->nama"
